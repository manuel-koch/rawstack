...
const char *LevelSettings::Name       = "level";
const char *LevelSettings::Blackpoint = "level.blackpoint";
const char *LevelSettings::Midpoint   = "level.midpoint";
const char *LevelSettings::Whitepoint = "level.whitepoint";
const char *LevelSettings::Brightness = "level.brightness";
